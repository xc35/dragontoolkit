...
/*     */ 
/*     */ public class IntSuperDenseMatrix extends AbstractDenseMatrix
...
/*     */ 
/*     */   public IntSuperDenseMatrix(String filename)
/*     */   {
/*  24 */     this(filename, 0, true);
/*     */   }
/*     */ 
/*     */   public IntSuperDenseMatrix(String filename, int columns, boolean readOnly) {
/*  28 */     super(0, columns, 4);
/*     */     try
/*     */     {
/*  31 */       this.curRow = -1;
/*  32 */       this.cache = null;
...
/*  39 */         this.rows = 0;
/*  40 */         this.raf.writeInt(this.rows);
/*  41 */         this.raf.writeInt(columns);
/*  42 */         this.raf.writeInt(this.rows * columns);
/*     */       }
/*     */       else {
...
/*  49 */         this.cache = new int[this.columns];
/*     */     }
/*     */     catch (Exception e) {
/*  52 */       this.raf = null;
/*     */     }
...
/*  77 */       this.rows += 1;
/*  78 */       this.curRow = row;
/*  79 */       MathUtil.initArray(this.cache, 0);
/*     */     }
...
/*  93 */       this.rows += 1;
/*  94 */       this.curRow = row;
/*  95 */       MathUtil.initArray(this.cache, 0);
/*     */     }
...
/* 160 */         this.raf.writeInt(this.cache[i]);
...
/* 176 */         this.cache[i] = this.raf.readInt();
/*     */     }
/*     */     catch (Exception e) {
 ...
 * Qualified Name:     dragon.matrix.IntSuperDenseMatrix
